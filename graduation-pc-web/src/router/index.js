...
const routes = [
  ...
  },
  {
    ...
    children: [
      //健康上报路由表
      {
        path: "/healthReport/infoNotice",
        component : () => import(/* webpackChunkName: "" */  '../views/healthReport/infoNotice/InfoNotice.vue')
      },
      {
        path: "/healthReport/reportProblem",
        component : () => import(/* webpackChunkName: "" */  '../views/healthReport/reportProblem/ReportProblem.vue')
      },
      {
        path: "/healthReport/reportRecord",
        component : () => import(/* webpackChunkName: "" */  '../views/healthReport/reportRecord/ReportRecord.vue')
      },
      
      //权限管理
      {
        path: "/authorityManage/menuManage",
        component : () => import(/* webpackChunkName: "" */  '../views/authorityManage/menuManage/MenuManage.vue')
      },
      {
        path: "/authorityManage/organizeManage",
        component : () => import(/* webpackChunkName: "" */  '../views/authorityManage/organizeManage/OrganizeManage.vue')
      },
      {
        path: "/authorityManage/roleManage",
        component : () => import(/* webpackChunkName: "" */  '../views/authorityManage/roleManage/RoleManage.vue')
      },
      {
        path: "/authorityManage/userManage",
        component : () => import(/* webpackChunkName: "" */  '../views/authorityManage/userManage/UserManage.vue')
      },
      //系统设置
      {
